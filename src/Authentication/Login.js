    ...
    return (
        <div className='w-screen h-screen flex p-5'>
            <div className=' flex-col m-auto w-fit h-fit  p-5 '>
                <p className=' flex text-[3.5rem] mx-auto'>De<span className='primary'>Fi</span></p>
                <p>Sign In Into Your account</p>
                <p>{error}</p>
                <div className=' text-[13px] marker:flex-col my-5 p-5 border border-xl border-[#d8dee4] rounded bg-[#f6f8fa] '>
                ...
                <div className='flex my-2 p-5 text-[13px] text-black border border-[#d8dee4] border-xl rounded bg-[#f6f8fa]'>
                    <p className=' '>New To Defi? </p>
                    <p className='  text-blue-500'> Create An Account?</p>
                </div>

                <div className='flex justify-between mx-auto  text-[12px] py-10 mt-10'>
                    <p >Terms</p>
                    <p  >Privacy</p>
                    <p >Security</p>
                    <p >Contact DeFi</p>
